 ...
 */
add_filter( 'dynamic_sidebar_params', 'labtheme_widget_classes' );

if ( ! function_exists( 'labtheme_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function labtheme_widget_classes( $params ) {
...
} // End of if function_exists( 'labtheme_widget_classes' ).

add_action( 'widgets_init', 'labtheme_widgets_init' );

if ( ! function_exists( 'labtheme_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function labtheme_widgets_init() {

		register_sidebar(
			array(
				'name'          => __( 'Footer Contact Info', 'labtheme' ),
				'id'            => 'footer-sidebar',
				'description'   => __( 'Footer widget area', 'labtheme' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<p class="widget-title mb-0"><strong>',
				'after_title'   => '</strong></p>',
			)
		);

	}
} // End of function_exists( 'labtheme_widgets_init' ).
