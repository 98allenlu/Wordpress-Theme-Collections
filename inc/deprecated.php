...
if ( ! function_exists( 'labtheme_adjust_body_class' ) ) {
	/**
	 * Setup body classes.
	 *
	 ...
	 */
	function labtheme_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'labtheme_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function labtheme_slbd_count_widgets( $sidebar_id ) {
