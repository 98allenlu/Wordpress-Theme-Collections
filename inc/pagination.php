...
if ( ! function_exists( 'labtheme_pagination' ) ) {
	/**
	 ...
	 */
	function labtheme_pagination( $args = array(), $class = 'pagination wrapper bottom' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'labtheme' ),
				'next_text'          => __( '&raquo;', 'labtheme' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'labtheme' ),
			)
		);
