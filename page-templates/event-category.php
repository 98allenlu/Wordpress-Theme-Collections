 ...
 *
 * Template for displaying the custom Events Category pages.
 *
 * @package LAB Theme
 */
...
$event_category = get_field('event_category', $current);
?>
		...
		<div class="container-fluid" tabindex="-1">
			...
			<div class="row">
				...
				<div class="col-md">
					...
					<?php echo do_shortcode( '[tribe_events view="list" category="' . $event_category->slug . '"]' ); ?>
