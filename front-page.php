...
<?php
$current = get_the_ID();
// RESTORED: Hero-related variables
$hero_image = get_the_post_thumbnail_url($current);
$hero_headline = get_field('hero_headline', $current);
$hero_copy = get_field('hero_copy', $current);
$hero_buttons = get_field('hero_buttons', $current);
...
// RESTORED: CTA-related variables
$cta_bg = get_field('cta_bg', $current);
$cta_headline = get_field('cta_headline', $current);
$cta_copy = get_field('cta_copy', $current);
$cta_buttons = get_field('cta_buttons', $current);
?>
	...
	<?php } ?>
		...
		<div class="hero-content">
			...
			<div class="container-fluid">
				...
				<div class="hero-content-inner para-content">
					...
					<?php
					printf( wp_kses_post( __( '<h1>%s</h1>', 'labtheme' ) ), $hero_headline );
					...
					if( $hero_buttons ) {
						...
						foreach ( $hero_buttons as $button ) {
							...
							printf( '<a class="btn btn-light mt-2 mr-2" href="%1$s">%2$s</a>',
	...
	</div></div><div id="site-content"> <div class="wrapper" id="events-wrapper">
		...
		<div class="container-fluid" tabindex="-1">
			...
			<div class="row">
				...
				<div class="col-md col-lg-6 d-flex align-items-center justify-content-center order-md-last">
					...
					<?php
					// ACF count check fix maintained here
			...
			<div class="row justify-content-center">
				...
				<div class="col-md col-lg-6">
					...
					<div class="para-content">
						...
						<?php
						printf( wp_kses_post( __( '<h3>%s</h3>', 'labtheme' ) ), $cta_headline );

						if( $cta_copy ) {

							echo apply_filters( 'the_content', wp_kses_post( $cta_copy ) );
						...
						if( $cta_buttons ) {
							...
							foreach ( $cta_buttons as $button ) {
								...
								printf( '<a class="btn btn-outline mt-2 ml-2 mr-2" href="%1$s">%2$s</a>',
									esc_url( $button['button_link']['url'] ),
									esc_html( $button['button_text'] )
								);
